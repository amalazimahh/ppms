...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <script>
            var demo = {
                showNotification: function (positionVertical, positionHorizontal, message) {
                    $.notify({
                        ...
                        type: 'success',
                        placement: {
                            from: positionVertical,
                            align: positionHorizontal
                        },
                        timer: 3000
                    });
                }
        ...
        <!-- script for notification to be marked as 'read' when admin views it -->
        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        <script>
            $(document).ready(function (){
                // when the notification icon is clicked
                $('.dropdown-toggle.notification-icon').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (response){
                            ...
                            // optionally update UI to reflect notifications as read
                            //$('.notification').removeClass('d-none'); //hide notification badge
                            //$('.dropdown-navbar').find('.nav-link').remove(); //clear dropdown items

                            // show no new notifications message
                            //$('.dropdown-navbar').append('<li class="nav-link"><a href="#" class="nav-item dropdown-item">No new notifications</a></li>');
                        },
