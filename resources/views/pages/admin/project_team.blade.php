      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary d-flex justify-content-between align-items-center">
            <h2 class="card-title m-0">Project Teams</h2>
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <select id="filterType" class="form-control" onchange="window.location.href = this.value">
                ...
                <option value="">Reset Password Request</option>
                <option value="">Upcoming Deadline Projects</option>
                <option value="">Project Details Updates</option>
                <option value="">Project Status Updates</option>
                <option value="">Overbudget Projects</option>
                <option value="">Overdue Projects</option>
              </select>
            </div>
